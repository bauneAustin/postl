...
export default function DropDown(props: { requestState: State, dispatch: ActionDispatch<[action: RequestAction]> }) {
    ...
    return (
        <div className="cursor-pointer font-semibold">
            <select
                ...
                name="post_method"
                id="post_method">
                <option className={`${getTextColor('get')}`} value="get">GET</option>
                <option className={`${getTextColor('post')}`} value="post">POST</option>
                <option className={`${getTextColor('put')}`} value="put">PUT</option>
                <option className={`${getTextColor('patch')}`} value="patch">PATCH</option>
                <option className={`${getTextColor('delete')}`} value="delete">DELETE</option>
            </select>
        </div>
    );
};
